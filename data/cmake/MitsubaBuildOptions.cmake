...
if (MTS_CMAKE_INIT)
  ...
  if (CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
    set(MTS_CXX_FLAGS "-fvisibility=hidden -pipe -march=nocona -Wall -Winvalid-pch")
  endif()
...
option(MTS_SINGLE_PRECISION
  "Do all computation in single precision. This is usually sufficient." OFF)
